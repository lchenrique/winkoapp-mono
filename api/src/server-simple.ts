...
async function buildServer() {
  ...
  // Decorator para Socket.IO (será definido após inicialização)
...
async function start() {
  try {
    ...
    // Initialize Socket.IO directly on the Fastify server
    ...
    console.log(`📡 Socket.IO ready at ws://${HOST}:${PORT}`);
  } catch (error) {
